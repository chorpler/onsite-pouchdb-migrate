...
runServer(server, function (serverHost) {
  // console.log(`runServer(): Calling runTests() …`);
...
function runTests(client, serverHost) {
  if (client === 'node') {
    // console.log(`runTests(): Called in 'node' mode …`);
    ...
    // console.log(`runTests(): Building Karma config …`);
    var options = buildKarmaConf(client, serverHost);
    // console.log(`runTests(): Karma config is:\n`, options);
