...
function runServer(serverName, runTests) {
  // console.log(`runServer(): Called from run-server.js …`);
  ...
  return Promise.resolve().then(function () {
    // console.log(`runServer(): Checking server …`);
    if (!server) {
      // console.log(`runServer(): No server!`);
      return {
    ...
    if (server.name === 'couchdb') {
      // console.log(`runServer(): Server is CouchDB`);
    ...
    // PouchDB Server
      ...
      // console.log(`runServer(): Server is pouchdb-server …`);
      return {
    ...
    console.log(`runServer(): Server checked, about to wait for CouchDB …`);
